...
type DetailTab = 'brief' | 'assets' | 'links' | 'documentation' | 'tasks' | 'preview';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tabBar}>
        ...
        <button
          className={`${styles.tab} ${activeTab === 'documentation' ? styles.tabActive : ''}`}
          ...
          <section className={styles.section}>
            ...
            <div className={styles.card}>
              {campaign.assets && campaign.assets.length > 0 ? (
                ...
                <p className={styles.emptyText}>No assets uploaded yet. Add images, documents, or media files to this campaign.</p>
              )}
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.card}>
              {campaign.entries && campaign.entries.length > 0 ? (
                ...
                <p className={styles.emptyText}>No content entries linked to this campaign yet.</p>
              )}
            </div>
          </section>
        </>
      ...
      {activeTab === 'links' && (
        <>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.card}>
              {campaign.utms && campaign.utms.length > 0 ? (
                ...
                <p className={styles.emptyText}>No UTM parameters configured. Add tracking URLs for campaign analytics.</p>
              )}
            </div>
          </section>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Market Research Links</h2>
            <div className={styles.card}>
              {campaign.market_research_links && campaign.market_research_links.length > 0 ? (
                ...
                <p className={styles.emptyText}>No market research links added. Add relevant research documents and resources.</p>
              )}
            </div>
          </section>
        </>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.card}>
              {campaign.contributors && campaign.contributors.length > 0 ? (
                ...
                <p className={styles.emptyText}>No contributors assigned to this campaign yet.</p>
              )}
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.card}>
              {campaign.timeline && campaign.timeline.length > 0 ? (
                ...
                <p className={styles.emptyText}>No milestones defined. Add milestones to track campaign progress and deadlines.</p>
              )}
            </div>
          </section>
        </>
