...
export const MOCK_CAMPAIGNS: Campaign[] = [
  ...
  {
    uid: 'blt_campaign_008',
    title: 'Earth Day Initiative',
    key_messages: createRTEBullets([
      'Celebrate Earth Day with sustainable choices.',
      'Plant a tree with every purchase over $50.',
      'Learn about our carbon-neutral shipping program.',
    ]),
    campaign_goals: createRTEBullets([
      'Plant 10,000 trees through customer purchases.',
      'Increase eco-friendly product sales by 30%.',
      'Generate 500 social media shares with #GreenWithUs hashtag.',
    ]),
    start_date: '2025-04-01',
    end_date: '2025-04-30',
    contributors: [
      { uid: 'user_003', _content_type_uid: 'users', name: 'Emma Wilson', role: 'Sustainability Lead', initials: 'EW' },
      { uid: 'user_007', _content_type_uid: 'users', name: 'David Park', role: 'Social Media Manager', initials: 'DP' },
    ],
    budget: '$35,000',
    status: 'draft',
    channels: ['Web', 'Social', 'Email'],
    assets: [
      { uid: 'asset_005', url: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800', filename: 'Earth Day Banner', content_type: 'image/jpeg' },
    ],
    timeline: [
      createMilestone('Campaign Planning', '2025-03-15', 'completed'),
      createMilestone('Asset Creation', '2025-03-25', 'in_progress'),
      createMilestone('Earth Day Launch', '2025-04-22', 'pending'),
      createMilestone('Campaign Wrap-up', '2025-04-30', 'pending'),
    ],
    market_research: createRTEContent('73% of millennials willing to pay more for sustainable products. Earth Day engagement up 25% YoY on social media.'),
    brand_kit: [{ uid: 'bk_003', title: 'Sustainability Focus' }],
    voice_profile: [{ uid: 'vp_003', title: 'Authentic & Transparent' }],
    audiences: [
      { id: 'aud_005', name: 'Eco-Conscious Shoppers', count: 15000 },
      { id: 'aud_012', name: 'Gen Z Customers', count: 8500 },
    ],
    releases: [],
    entries: [],
  ...
  {
    uid: 'blt_campaign_009',
    title: "Mother's Day Gift Collection",
    key_messages: createRTEBullets([
      'Show Mom how much you care with our curated gift selection.',
      'Free personalization on select items.',
      'Order by May 8th for guaranteed delivery.',
    ]),
    campaign_goals: createRTEBullets([
      'Achieve $500K in gift category sales.',
      'Increase gift card purchases by 40%.',
      'Drive 25,000 visits to Mother\'s Day landing page.',
    ]),
    start_date: '2025-05-01',
    end_date: '2025-05-11',
    contributors: [
      { uid: 'user_004', _content_type_uid: 'users', name: 'Alex Rivera', role: 'Campaign Manager', initials: 'AR' },
      { uid: 'user_008', _content_type_uid: 'users', name: 'Lisa Chen', role: 'Email Marketing', initials: 'LC' },
    ],
    budget: '$45,000',
    status: 'draft',
    channels: ['Web', 'Email', 'Social', 'Ads'],
    assets: [
      { uid: 'asset_006', url: 'https://images.unsplash.com/photo-1462275646964-a0e3571f4f82?w=800', filename: 'Mothers Day Hero', content_type: 'image/jpeg' },
    ],
    timeline: [
      createMilestone('Gift Guide Curation', '2025-04-15', 'pending'),
      createMilestone('Email Sequences Ready', '2025-04-25', 'pending'),
      createMilestone('Campaign Launch', '2025-05-01', 'pending'),
      createMilestone("Mother's Day", '2025-05-11', 'pending'),
    ],
    market_research: createRTEContent("Mother's Day spending expected to reach $31B nationally. Top categories: jewelry, experiences, flowers, apparel."),
    brand_kit: [{ uid: 'bk_006', title: 'Gift & Celebrations' }],
    voice_profile: [{ uid: 'vp_004', title: 'Warm & Festive' }],
    audiences: [
      { id: 'aud_006', name: 'Gift Shoppers', count: 25000 },
      { id: 'aud_013', name: 'Last-Minute Shoppers', count: 12000 },
    ],
    releases: [],
    entries: [],
  ...
  {
    uid: 'blt_campaign_010',
    title: 'Summer Kickoff Sale',
    key_messages: createRTEBullets([
      'Summer starts here! Up to 40% off seasonal favorites.',
      'New arrivals in outdoor, swimwear, and travel gear.',
      'Free shipping on orders over $75 all month long.',
    ]),
    campaign_goals: createRTEBullets([
      'Clear 60% of spring inventory.',
      'Drive $1.2M in summer category revenue.',
    ...
    contributors: [
      { uid: 'user_001', _content_type_uid: 'users', name: 'Sarah Johnson', role: 'Marketing Director', initials: 'SJ' },
      { uid: 'user_005', _content_type_uid: 'users', name: 'Jordan Lee', role: 'Promotions Lead', initials: 'JL' },
    ],
    budget: '$80,000',
    status: 'draft',
    channels: ['Web', 'Email', 'Social', 'Ads', 'Native Mobile'],
    assets: [
      { uid: 'asset_007', url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800', filename: 'Summer Beach Banner', content_type: 'image/jpeg' },
    ],
    timeline: [
      createMilestone('Inventory Planning', '2025-05-15', 'pending'),
      createMilestone('Creative Production', '2025-05-20', 'pending'),
      createMilestone('Campaign Launch', '2025-06-01', 'pending'),
      createMilestone('Mid-Month Optimization', '2025-06-15', 'pending'),
      createMilestone('Final Push', '2025-06-25', 'pending'),
    ],
    market_research: createRTEContent('Summer retail season starts Memorial Day weekend. Key categories: outdoor living, travel, swimwear. Competitor analysis shows 30-50% discount range.'),
    brand_kit: [{ uid: 'bk_007', title: 'Summer Vibes' }],
    voice_profile: [{ uid: 'vp_008', title: 'Fun & Energetic' }],
    audiences: [
      { id: 'aud_014', name: 'Summer Shoppers', count: 35000 },
      { id: 'aud_015', name: 'Deal Seekers', count: 28000 },
    ],
    releases: [],
    entries: [],
